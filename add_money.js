const username = localStorage.getItem('winner_local');
if (!username) {
    alert('Please Login First!');
}

const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbx2sfNjcwuZ1O5UpQke2B8bfpe5wIipZWxVNZ35j3Rp2k7JNCRm-ifEwWaKd_sEnU456A/exec';
