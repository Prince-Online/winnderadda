function getUsernameFromLocalStorage() {
  return localStorage.getItem('winner_local');
}
...
function fetchUserCoins(username) {
  ...
  const url = 'https://script.google.com/macros/s/AKfycbzvSEZFLXKROAQMghmn3UYl_5Q7OZV7OsHwntXjCsXhKW-GL0swsdTItHdthDym4OA_EQ/exec';
